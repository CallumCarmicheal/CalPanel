				...
				<div class="col-md-9">
					<div class="tab-content">
						...
						<div class="tab-pane" id="manage_users">
							...
							<div class="inputer inputer-<?php echo e($PAGE['Header']['Color']); ?>">
								<div class="input-wrapper">
									<input type="text" id="page_users_add" class="form-control" placeholder="Enter user's email">
								</div>
							</div>
								...
								<?php $__currentLoopData = $role->usersInRole(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
									<li class="has-action-left page-edit-user-tab" style="cursor: default; background-color: #F7F7F7;">
										<a class="hidden" style="cursor:pointer;">
											<i class="glyphicon glyphicon-trash page-user-btn" user_id="<?php echo e($user->getID()); ?>"></i>
										</a>
