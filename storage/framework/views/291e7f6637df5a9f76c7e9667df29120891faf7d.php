<?php 
	$dImg = "https://s.gravatar.com/avatar/23463b99b62a72f26ed677cc556c44e8?s=128";;
					...
					<li class="has-action-left">
						...
						<a href="#" class="visible">
							<div class="list-action-left">
								<img src="<?php echo e($dImg); ?>" class="face-radius" alt="">
							</div>
			...
			<div class="result result-posts">
				...
				<ul class="list-material">
					<li class="has-action-left">
						...
						<a href="#" class="visible">
							<div class="list-action-left">
								<img src="<?php echo e($dImg); ?>" class="img-radius" alt="">
							</div>
							<div class="list-content">
